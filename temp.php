...
$token="5166667335:AAHjZOISN4lKAzyV2y5ZGY3e5HjryZlzFyk";
...
#--------(carlos)--------#
if( $text=="م" &&  $tc == "private" or $text=="꙳. رجوع" &&  $tc == "private" ){
if (in_array($from_id,$Dev)) {
bot('sendmessage',[
'chat_id'=>$chat_id,
...
$new = json_decode(file_get_contents("https:/mail.php/method=getNewMail"),true);
...
$mssg = $tr[$from_id]["email"];
$url0  = file_get_contents("https://رابط مسار ملف الايبي الخاص فيك?method=getMessages&email=$mssg");
